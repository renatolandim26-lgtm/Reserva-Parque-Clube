          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_1fr] items-center">
            <div className="relative group overflow-hidden rounded-[2.5rem] border border-primary/30 shadow-[0_0_50px_rgba(197,160,89,0.1)] bg-[#050505]">
              <div className="relative aspect-[3/2] overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-end pb-8 sm:pb-12 lg:pb-14 px-6">
                  <button
                    onClick={() => setShowConsultantSelector(true)}
                    className="group/btn relative flex items-center gap-3 rounded-full bg-gradient-to-r from-[#C5A059] to-[#8E723D] px-8 py-4 sm:px-10 sm:py-5 font-bold text-black shadow-[0_10px_30px_rgba(197,160,89,0.5)] transition-all hover:scale-105 hover:shadow-[0_15px_40px_rgba(197,160,89,0.7)] active:scale-95 border border-white/20"
                  >
                    <div className="rounded-full bg-black/10 p-1">
                      <MessageCircle size={24} fill="currentColor" />
                    </div>
                    <span className="text-base sm:text-xl uppercase tracking-wider">Fale agora pelo WhatsApp</span>
                  </button>
                </div>
              </div>
